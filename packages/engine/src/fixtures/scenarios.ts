...
export const scenarioC: ScenarioFixture = {
  ...
  user_model_overrides: {
    ...
    constraints_json: {
      // hip_mobility_scan is a scan identifier, NOT a real body discomfort flag
      // It affects scoring but not safety veto or readiness downgrade
      discomfort_areas: ['hip_mobility_scan'],
      medical_context_tags: [],
    },
    latest_body_state_json: {
      discomfort_flags: [], // no actual body discomfort
...
export const scenarioD: ScenarioFixture = {
  ...
  user_model_overrides: {
    recent_behavior_json: {
      ...
      // Exactly 3 skips — matching "missed three days"
