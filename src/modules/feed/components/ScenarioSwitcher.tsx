 ...
 *
 * Per acceptance criteria: lets a tester cycle through Sienna's four canonical
 * states without having to fire signals manually.
 *
...
const SCENARIOS: Array<{
  ...
  { key: 'A', label: 'A: Rested Tuesday', description: 'Happy readiness, 3 sessions, sleep 7h' },
