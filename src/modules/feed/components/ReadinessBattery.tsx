...
/**
 * ReadinessBattery — three-state readiness indicator per spec §12.1.
 *
 * States:
 * - high: battery icon, pulsing green stroke (1.2s cycle, 8% opacity swing)
 * - medium: battery icon, static green stroke
 * - low: ~40% fill, warm amber stroke, no animation
 *
 * Labels: "Ready" (high), "Steady" (medium), "Light today" (low) — Simon approved copy
 */
...
export function ReadinessBattery({
  ...
  useEffect(() => {
    ...
    // 1.2s cycle, ~8% opacity swing per spec §12.1
