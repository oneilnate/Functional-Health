 ...
 * - rationale_expanded text (2 sentences, observational-warm per spec §11)
 * - Play button stub (disabled in v1, audio_rationale_url === null)
 * - cross_modality_note below a thin divider if present
    ...
    >
      ...
      <View style={styles.sheet}>
        ...
        <ScrollView bounces={false} showsVerticalScrollIndicator={false}>
          ...
          {/* Audio button stub — v1.1 per spec §9.4 */}
          <Pressable
          ...
          {/* Cross-modality note below divider */}
